...
_90=_90.replace(/{page}/,_8e.pageNumber);
_90=_90.replace(/{pages}/,Math.ceil(_8e.total / _8e.pageSize));
_90=_90.replace(/{pageSize}/,_8e.pageSize);
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["field","align","halign","order",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number",width:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):function(data,record,index){return data!=null&&data!=undefined&&data.toString().trim()!==''?data:'--'}),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
if(th.attr("editor")){
...
//xw singleSelect去除全选框 只允许选择一个
if(opts.singleSelect){
	$(_51c).parent().find('.datagrid-header-row input[type=checkbox]').remove();
	$(_51c).parent().find('.datagrid-cell-check input[type=checkbox]').change(function(){
		var checked = this.checked;
		$(_51c).datagrid('uncheckAll');
		if(checked)this.checked = true;
	});
}
$(_51c).data().datagrid.checkedRows=[]; //xw 数据加载完毕清除已选项
